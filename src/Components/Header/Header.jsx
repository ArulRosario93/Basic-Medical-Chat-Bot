        ...
        <div className="Header">
            <div className="HeaderDivide">
                <div className="dividedLeft">
                    <h3 style={{margin: '0px', fontFamily: 'Open Sans, sans-serif', fontWeight: 600,  fontSize: 'medium'}}>CoCo</h3>
                    <p style={{margin: '0%',fontFamily: 'Roboto, sans-serif', fontSize: 'smaller'}}>Your Personal Medical Assistant CoCo</p>
                </div>
